...
public class _06_ApachePOISteps {
    ...
    public void userCreateCitizenshipWithApachePOI() {
        ArrayList<ArrayList<String>> tablo=ExelUtility.getListData("src/test/java/ApachePOI/resource/ApacheExcel2.xlsx","testCitizen",2);
    ...
    public void userDeleteCitizenshipWithApachePOI() {
        ArrayList<ArrayList<String>> tablo=ExelUtility.getListData("src/test/java/ApachePOI/resource/ApacheExcel2.xlsx","testCitizen",1);
